...
out_gdb = r"C:\Users\JEEVA\Documents\ArcGIS\Default2.gdb"
env.workspace = "D:\\CROP_SUMMARY_SUND\\"
env.mask = "D:\\CROP_SUMMARY_SUND\\sundarban_landuse\\sundarban_landuse.shp"
env.extent= "D:\\CROP_SUMMARY_SUND\\sundarban_landuse\\sundarban_landuse.shp"
arcpy.env.parallelProcessingFactor = "100%"
arcpy.env.overwriteOutput = True

# Set local variables
outPath = "D:\\CROP_SUMMARY_SUND\\yield-out\\"
inPath="D:\\CROP_SUMMARY_SUND\\yield_in\\"
mxd=arcpy.mapping.MapDocument(r"D:\\CROP_SUMMARY_SUND\\idw-yield-sund.mxd")
...
for file in os.listdir(inPath):
     ...
     if file.endswith(".csv"):
        ...
        arcpy.MakeXYEventLayer_management(in_table,"LON","LAT",out_table)
        arcpy.SaveToLayerFile_management(out_table, out_layer)
        input = out_table
        cellSize = 0.0017078076
        power = 2
        ...
        # here in this case i have removed first 2 field
        zfield = zfield[3::]
        ...
        for f in zfield:
            ...
            #toplyr=arcpy.mapping.ListLayers(mxd,outfile)
